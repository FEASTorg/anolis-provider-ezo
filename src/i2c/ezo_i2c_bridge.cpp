...
ezo_result_t transport_write_then_read(void *context, uint8_t address,
  ...
  const Status status = session->write_then_read(address, tx_data, tx_len,
                                                 rx_data, rx_len, rx_received);
